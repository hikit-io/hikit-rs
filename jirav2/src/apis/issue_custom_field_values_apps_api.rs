...
pub struct UpdateMultipleCustomFieldValuesParams {
    pub multiple_custom_field_values_update_details: crate::models::MultipleCustomFieldValuesUpdateDetails,
    /// Whether to generate a changelog for this update.
    pub generate_changelog: Option<bool>
}
...
pub async fn update_custom_field_value(configuration: &configuration::Configuration, params: UpdateCustomFieldValueParams) -> Result<serde_json::Value, Error<UpdateCustomFieldValueError>> {
...
pub async fn update_multiple_custom_field_values(configuration: &configuration::Configuration, params: UpdateMultipleCustomFieldValuesParams) -> Result<serde_json::Value, Error<UpdateMultipleCustomFieldValuesError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let multiple_custom_field_values_update_details = params.multiple_custom_field_values_update_details;
    let generate_changelog = params.generate_changelog;
