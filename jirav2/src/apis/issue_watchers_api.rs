...
pub async fn add_watcher(configuration: &configuration::Configuration, params: AddWatcherParams) -> Result<serde_json::Value, Error<AddWatcherError>> {
...
pub async fn get_is_watching_issue_bulk(configuration: &configuration::Configuration, params: GetIsWatchingIssueBulkParams) -> Result<crate::models::BulkIssueIsWatching, Error<GetIsWatchingIssueBulkError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_watchers(configuration: &configuration::Configuration, params: GetIssueWatchersParams) -> Result<crate::models::Watchers, Error<GetIssueWatchersError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_watcher(configuration: &configuration::Configuration, params: RemoveWatcherParams) -> Result<(), Error<RemoveWatcherError>> {
    let local_var_configuration = configuration;
