...
pub async fn delete_avatar(configuration: &configuration::Configuration, params: DeleteAvatarParams) -> Result<(), Error<DeleteAvatarError>> {
...
pub async fn get_all_system_avatars(configuration: &configuration::Configuration, params: GetAllSystemAvatarsParams) -> Result<crate::models::SystemAvatars, Error<GetAllSystemAvatarsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_avatar_image_by_id(configuration: &configuration::Configuration, params: GetAvatarImageByIdParams) -> Result<serde_json::Value, Error<GetAvatarImageByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_avatar_image_by_owner(configuration: &configuration::Configuration, params: GetAvatarImageByOwnerParams) -> Result<serde_json::Value, Error<GetAvatarImageByOwnerError>> {
    let local_var_configuration = configuration;
...
pub async fn get_avatar_image_by_type(configuration: &configuration::Configuration, params: GetAvatarImageByTypeParams) -> Result<serde_json::Value, Error<GetAvatarImageByTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_avatars(configuration: &configuration::Configuration, params: GetAvatarsParams) -> Result<crate::models::Avatars, Error<GetAvatarsError>> {
    let local_var_configuration = configuration;
...
pub async fn store_avatar(configuration: &configuration::Configuration, params: StoreAvatarParams) -> Result<crate::models::Avatar, Error<StoreAvatarError>> {
    let local_var_configuration = configuration;
