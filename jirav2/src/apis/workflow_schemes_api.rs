...
pub async fn create_workflow_scheme(configuration: &configuration::Configuration, params: CreateWorkflowSchemeParams) -> Result<crate::models::WorkflowScheme, Error<CreateWorkflowSchemeError>> {
...
pub async fn delete_default_workflow(configuration: &configuration::Configuration, params: DeleteDefaultWorkflowParams) -> Result<crate::models::WorkflowScheme, Error<DeleteDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_mapping(configuration: &configuration::Configuration, params: DeleteWorkflowMappingParams) -> Result<(), Error<DeleteWorkflowMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_scheme(configuration: &configuration::Configuration, params: DeleteWorkflowSchemeParams) -> Result<serde_json::Value, Error<DeleteWorkflowSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_scheme_issue_type(configuration: &configuration::Configuration, params: DeleteWorkflowSchemeIssueTypeParams) -> Result<crate::models::WorkflowScheme, Error<DeleteWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_workflow_schemes(configuration: &configuration::Configuration, params: GetAllWorkflowSchemesParams) -> Result<crate::models::PageBeanWorkflowScheme, Error<GetAllWorkflowSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_default_workflow(configuration: &configuration::Configuration, params: GetDefaultWorkflowParams) -> Result<crate::models::DefaultWorkflow, Error<GetDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow(configuration: &configuration::Configuration, params: GetWorkflowParams) -> Result<crate::models::IssueTypesWorkflowMapping, Error<GetWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme(configuration: &configuration::Configuration, params: GetWorkflowSchemeParams) -> Result<crate::models::WorkflowScheme, Error<GetWorkflowSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme_issue_type(configuration: &configuration::Configuration, params: GetWorkflowSchemeIssueTypeParams) -> Result<crate::models::IssueTypeWorkflowMapping, Error<GetWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn set_workflow_scheme_issue_type(configuration: &configuration::Configuration, params: SetWorkflowSchemeIssueTypeParams) -> Result<crate::models::WorkflowScheme, Error<SetWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn update_default_workflow(configuration: &configuration::Configuration, params: UpdateDefaultWorkflowParams) -> Result<crate::models::WorkflowScheme, Error<UpdateDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_mapping(configuration: &configuration::Configuration, params: UpdateWorkflowMappingParams) -> Result<crate::models::WorkflowScheme, Error<UpdateWorkflowMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_scheme(configuration: &configuration::Configuration, params: UpdateWorkflowSchemeParams) -> Result<crate::models::WorkflowScheme, Error<UpdateWorkflowSchemeError>> {
    let local_var_configuration = configuration;
