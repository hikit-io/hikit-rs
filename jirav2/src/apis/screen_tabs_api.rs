...
pub async fn add_screen_tab(configuration: &configuration::Configuration, params: AddScreenTabParams) -> Result<crate::models::ScreenableTab, Error<AddScreenTabError>> {
...
pub async fn delete_screen_tab(configuration: &configuration::Configuration, params: DeleteScreenTabParams) -> Result<(), Error<DeleteScreenTabError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_screen_tabs(configuration: &configuration::Configuration, params: GetAllScreenTabsParams) -> Result<Vec<crate::models::ScreenableTab>, Error<GetAllScreenTabsError>> {
    let local_var_configuration = configuration;
...
pub async fn move_screen_tab(configuration: &configuration::Configuration, params: MoveScreenTabParams) -> Result<serde_json::Value, Error<MoveScreenTabError>> {
    let local_var_configuration = configuration;
...
pub async fn rename_screen_tab(configuration: &configuration::Configuration, params: RenameScreenTabParams) -> Result<crate::models::ScreenableTab, Error<RenameScreenTabError>> {
    let local_var_configuration = configuration;
