...
pub async fn archive_project(configuration: &configuration::Configuration, params: ArchiveProjectParams) -> Result<serde_json::Value, Error<ArchiveProjectError>> {
...
pub async fn create_project(configuration: &configuration::Configuration, params: CreateProjectParams) -> Result<crate::models::ProjectIdentifiers, Error<CreateProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_project_asynchronously(configuration: &configuration::Configuration, params: DeleteProjectAsynchronouslyParams) -> Result<(), Error<DeleteProjectAsynchronouslyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_projects(configuration: &configuration::Configuration, params: GetAllProjectsParams) -> Result<Vec<crate::models::Project>, Error<GetAllProjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_statuses(configuration: &configuration::Configuration, params: GetAllStatusesParams) -> Result<Vec<crate::models::IssueTypeWithStatus>, Error<GetAllStatusesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_hierarchy(configuration: &configuration::Configuration, params: GetHierarchyParams) -> Result<crate::models::ProjectIssueTypeHierarchy, Error<GetHierarchyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_notification_scheme_for_project(configuration: &configuration::Configuration, params: GetNotificationSchemeForProjectParams) -> Result<crate::models::NotificationScheme, Error<GetNotificationSchemeForProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project(configuration: &configuration::Configuration, params: GetProjectParams) -> Result<crate::models::Project, Error<GetProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn get_recent(configuration: &configuration::Configuration, params: GetRecentParams) -> Result<Vec<crate::models::Project>, Error<GetRecentError>> {
    let local_var_configuration = configuration;
...
pub async fn restore(configuration: &configuration::Configuration, params: RestoreParams) -> Result<crate::models::Project, Error<RestoreError>> {
    let local_var_configuration = configuration;
...
pub async fn search_projects(configuration: &configuration::Configuration, params: SearchProjectsParams) -> Result<crate::models::PageBeanProject, Error<SearchProjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_project(configuration: &configuration::Configuration, params: UpdateProjectParams) -> Result<crate::models::Project, Error<UpdateProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn update_project_type(configuration: &configuration::Configuration, params: UpdateProjectTypeParams) -> Result<crate::models::Project, Error<UpdateProjectTypeError>> {
    let local_var_configuration = configuration;
