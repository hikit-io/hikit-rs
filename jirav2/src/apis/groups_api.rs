...
pub async fn add_user_to_group(configuration: &configuration::Configuration, params: AddUserToGroupParams) -> Result<crate::models::Group, Error<AddUserToGroupError>> {
...
pub async fn bulk_get_groups(configuration: &configuration::Configuration, params: BulkGetGroupsParams) -> Result<crate::models::PageBeanGroupDetails, Error<BulkGetGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn find_groups(configuration: &configuration::Configuration, params: FindGroupsParams) -> Result<crate::models::FoundGroups, Error<FindGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_users_from_group(configuration: &configuration::Configuration, params: GetUsersFromGroupParams) -> Result<crate::models::PageBeanUserDetails, Error<GetUsersFromGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_group(configuration: &configuration::Configuration, params: RemoveGroupParams) -> Result<(), Error<RemoveGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_user_from_group(configuration: &configuration::Configuration, params: RemoveUserFromGroupParams) -> Result<(), Error<RemoveUserFromGroupError>> {
    let local_var_configuration = configuration;
