...
pub async fn get_audit_records(configuration: &configuration::Configuration, params: GetAuditRecordsParams) -> Result<crate::models::AuditRecords, Error<GetAuditRecordsError>> {
