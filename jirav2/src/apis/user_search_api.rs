...
pub async fn find_assignable_users(configuration: &configuration::Configuration, params: FindAssignableUsersParams) -> Result<Vec<crate::models::User>, Error<FindAssignableUsersError>> {
...
pub async fn find_bulk_assignable_users(configuration: &configuration::Configuration, params: FindBulkAssignableUsersParams) -> Result<Vec<crate::models::User>, Error<FindBulkAssignableUsersError>> {
    let local_var_configuration = configuration;
...
pub async fn find_user_keys_by_query(configuration: &configuration::Configuration, params: FindUserKeysByQueryParams) -> Result<crate::models::PageBeanUserKey, Error<FindUserKeysByQueryError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users(configuration: &configuration::Configuration, params: FindUsersParams) -> Result<Vec<crate::models::User>, Error<FindUsersError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users_by_query(configuration: &configuration::Configuration, params: FindUsersByQueryParams) -> Result<crate::models::PageBeanUser, Error<FindUsersByQueryError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users_for_picker(configuration: &configuration::Configuration, params: FindUsersForPickerParams) -> Result<crate::models::FoundUsers, Error<FindUsersForPickerError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users_with_all_permissions(configuration: &configuration::Configuration, params: FindUsersWithAllPermissionsParams) -> Result<Vec<crate::models::User>, Error<FindUsersWithAllPermissionsError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users_with_browse_permission(configuration: &configuration::Configuration, params: FindUsersWithBrowsePermissionParams) -> Result<Vec<crate::models::User>, Error<FindUsersWithBrowsePermissionError>> {
    let local_var_configuration = configuration;
