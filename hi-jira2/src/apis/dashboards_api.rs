...
pub async fn add_gadget(configuration: &configuration::Configuration, params: AddGadgetParams) -> Result<crate::models::DashboardGadget, Error<AddGadgetError>> {
...
pub async fn copy_dashboard(configuration: &configuration::Configuration, params: CopyDashboardParams) -> Result<crate::models::Dashboard, Error<CopyDashboardError>> {
    let local_var_configuration = configuration;
...
pub async fn create_dashboard(configuration: &configuration::Configuration, params: CreateDashboardParams) -> Result<crate::models::Dashboard, Error<CreateDashboardError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_dashboard(configuration: &configuration::Configuration, params: DeleteDashboardParams) -> Result<(), Error<DeleteDashboardError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_dashboard_item_property(configuration: &configuration::Configuration, params: DeleteDashboardItemPropertyParams) -> Result<(), Error<DeleteDashboardItemPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_dashboards(configuration: &configuration::Configuration, params: GetAllDashboardsParams) -> Result<crate::models::PageOfDashboards, Error<GetAllDashboardsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_gadgets(configuration: &configuration::Configuration, params: GetAllGadgetsParams) -> Result<crate::models::DashboardGadgetResponse, Error<GetAllGadgetsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_dashboard(configuration: &configuration::Configuration, params: GetDashboardParams) -> Result<crate::models::Dashboard, Error<GetDashboardError>> {
    let local_var_configuration = configuration;
...
pub async fn get_dashboard_item_property(configuration: &configuration::Configuration, params: GetDashboardItemPropertyParams) -> Result<crate::models::EntityProperty, Error<GetDashboardItemPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_dashboard_item_property_keys(configuration: &configuration::Configuration, params: GetDashboardItemPropertyKeysParams) -> Result<crate::models::PropertyKeys, Error<GetDashboardItemPropertyKeysError>> {
    let local_var_configuration = configuration;
...
pub async fn get_dashboards_paginated(configuration: &configuration::Configuration, params: GetDashboardsPaginatedParams) -> Result<crate::models::PageBeanDashboard, Error<GetDashboardsPaginatedError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_gadget(configuration: &configuration::Configuration, params: RemoveGadgetParams) -> Result<serde_json::Value, Error<RemoveGadgetError>> {
    let local_var_configuration = configuration;
...
pub async fn set_dashboard_item_property(configuration: &configuration::Configuration, params: SetDashboardItemPropertyParams) -> Result<serde_json::Value, Error<SetDashboardItemPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn update_dashboard(configuration: &configuration::Configuration, params: UpdateDashboardParams) -> Result<crate::models::Dashboard, Error<UpdateDashboardError>> {
    let local_var_configuration = configuration;
...
pub async fn update_gadget(configuration: &configuration::Configuration, params: UpdateGadgetParams) -> Result<serde_json::Value, Error<UpdateGadgetError>> {
    let local_var_configuration = configuration;
