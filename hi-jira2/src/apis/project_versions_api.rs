...
pub struct CreateVersionParams {
    pub version: crate::models::Version,
}
...
pub struct DeleteAndReplaceVersionParams {
    ...
    pub id: String,
    pub delete_and_replace_version_bean: crate::models::DeleteAndReplaceVersionBean,
}
...
pub struct MoveVersionParams {
    ...
    pub id: String,
    pub version_move_bean: crate::models::VersionMoveBean,
}
