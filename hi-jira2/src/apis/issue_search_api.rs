...
pub struct MatchIssuesParams {
    pub issues_and_jql_queries: crate::models::IssuesAndJqlQueries
}
...
pub struct SearchForIssuesUsingJqlPostParams {
    ...
    pub search_request_bean: crate::models::SearchRequestBean
}
...
pub async fn get_issue_picker_resource(configuration: &configuration::Configuration, params: GetIssuePickerResourceParams) -> Result<crate::models::IssuePickerSuggestions, Error<GetIssuePickerResourceError>> {
...
pub async fn match_issues(configuration: &configuration::Configuration, params: MatchIssuesParams) -> Result<crate::models::IssueMatches, Error<MatchIssuesError>> {
    let local_var_configuration = configuration;
...
pub async fn search_for_issues_using_jql(configuration: &configuration::Configuration, params: SearchForIssuesUsingJqlParams) -> Result<crate::models::SearchResults, Error<SearchForIssuesUsingJqlError>> {
    let local_var_configuration = configuration;
...
pub async fn search_for_issues_using_jql_post(configuration: &configuration::Configuration, params: SearchForIssuesUsingJqlPostParams) -> Result<crate::models::SearchResults, Error<SearchForIssuesUsingJqlPostError>> {
    let local_var_configuration = configuration;
