...
/// struct for passing parameters to the method [`change_filter_owner`]
#[derive(Clone, Debug, Default)]
pub struct ChangeFilterOwnerParams {
    /// The ID of the filter to update.
    pub id: i64,
    /// The account ID of the new owner of the filter.
    pub change_filter_owner: crate::models::ChangeFilterOwner,
}
...
pub async fn change_filter_owner(
    ...
    params: ChangeFilterOwnerParams,
) -> Result<serde_json::Value, Error<ChangeFilterOwnerError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let id = params.id;
    let change_filter_owner = params.change_filter_owner;
...
pub async fn create_filter(
    ...
    let override_share_permissions = params.override_share_permissions;
