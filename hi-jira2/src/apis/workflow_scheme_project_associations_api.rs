...
pub async fn assign_scheme_to_project(configuration: &configuration::Configuration, params: AssignSchemeToProjectParams) -> Result<serde_json::Value, Error<AssignSchemeToProjectError>> {
...
pub async fn get_workflow_scheme_project_associations(configuration: &configuration::Configuration, params: GetWorkflowSchemeProjectAssociationsParams) -> Result<crate::models::ContainerOfWorkflowSchemeAssociations, Error<GetWorkflowSchemeProjectAssociationsError>> {
    let local_var_configuration = configuration;
