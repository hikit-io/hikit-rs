...
) -> Result<crate::models::PropertyKeys, Error<AddonPropertiesResourceGetAddonPropertiesGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::EntityProperty, Error<AddonPropertiesResourceGetAddonPropertyGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OperationMessage, Error<AddonPropertiesResourcePutAddonPropertyPutError>>
{
    let local_var_configuration = configuration;
