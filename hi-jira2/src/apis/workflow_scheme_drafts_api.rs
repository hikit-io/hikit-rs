...
pub struct PublishDraftWorkflowSchemeParams {
    ...
    pub publish_draft_workflow_scheme: crate::models::PublishDraftWorkflowScheme,
...
pub async fn create_workflow_scheme_draft_from_parent(configuration: &configuration::Configuration, params: CreateWorkflowSchemeDraftFromParentParams) -> Result<crate::models::WorkflowScheme, Error<CreateWorkflowSchemeDraftFromParentError>> {
...
pub async fn delete_draft_default_workflow(configuration: &configuration::Configuration, params: DeleteDraftDefaultWorkflowParams) -> Result<crate::models::WorkflowScheme, Error<DeleteDraftDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_draft_workflow_mapping(configuration: &configuration::Configuration, params: DeleteDraftWorkflowMappingParams) -> Result<(), Error<DeleteDraftWorkflowMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_scheme_draft(configuration: &configuration::Configuration, params: DeleteWorkflowSchemeDraftParams) -> Result<(), Error<DeleteWorkflowSchemeDraftError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_scheme_draft_issue_type(configuration: &configuration::Configuration, params: DeleteWorkflowSchemeDraftIssueTypeParams) -> Result<crate::models::WorkflowScheme, Error<DeleteWorkflowSchemeDraftIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_draft_default_workflow(configuration: &configuration::Configuration, params: GetDraftDefaultWorkflowParams) -> Result<crate::models::DefaultWorkflow, Error<GetDraftDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_draft_workflow(configuration: &configuration::Configuration, params: GetDraftWorkflowParams) -> Result<crate::models::IssueTypesWorkflowMapping, Error<GetDraftWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme_draft(configuration: &configuration::Configuration, params: GetWorkflowSchemeDraftParams) -> Result<crate::models::WorkflowScheme, Error<GetWorkflowSchemeDraftError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme_draft_issue_type(configuration: &configuration::Configuration, params: GetWorkflowSchemeDraftIssueTypeParams) -> Result<crate::models::IssueTypeWorkflowMapping, Error<GetWorkflowSchemeDraftIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn publish_draft_workflow_scheme(configuration: &configuration::Configuration, params: PublishDraftWorkflowSchemeParams) -> Result<(), Error<PublishDraftWorkflowSchemeError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let id = params.id;
    let publish_draft_workflow_scheme = params.publish_draft_workflow_scheme;
...
pub async fn set_workflow_scheme_draft_issue_type(configuration: &configuration::Configuration, params: SetWorkflowSchemeDraftIssueTypeParams) -> Result<crate::models::WorkflowScheme, Error<SetWorkflowSchemeDraftIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn update_draft_default_workflow(configuration: &configuration::Configuration, params: UpdateDraftDefaultWorkflowParams) -> Result<crate::models::WorkflowScheme, Error<UpdateDraftDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn update_draft_workflow_mapping(configuration: &configuration::Configuration, params: UpdateDraftWorkflowMappingParams) -> Result<crate::models::WorkflowScheme, Error<UpdateDraftWorkflowMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_scheme_draft(configuration: &configuration::Configuration, params: UpdateWorkflowSchemeDraftParams) -> Result<crate::models::WorkflowScheme, Error<UpdateWorkflowSchemeDraftError>> {
    let local_var_configuration = configuration;
