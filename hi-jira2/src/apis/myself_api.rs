...
pub struct SetLocaleParams {
    ...
    pub locale: crate::models::Locale
}
...
pub async fn get_current_user(configuration: &configuration::Configuration, params: GetCurrentUserParams) -> Result<crate::models::User, Error<GetCurrentUserError>> {
    let local_var_configuration = configuration;
...
pub async fn get_preference(configuration: &configuration::Configuration, params: GetPreferenceParams) -> Result<String, Error<GetPreferenceError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_preference(configuration: &configuration::Configuration, params: RemovePreferenceParams) -> Result<(), Error<RemovePreferenceError>> {
    let local_var_configuration = configuration;
...
pub async fn set_locale(configuration: &configuration::Configuration, params: SetLocaleParams) -> Result<serde_json::Value, Error<SetLocaleError>> {
    let local_var_configuration = configuration;
...
pub async fn set_preference(configuration: &configuration::Configuration, params: SetPreferenceParams) -> Result<serde_json::Value, Error<SetPreferenceError>> {
    let local_var_configuration = configuration;
