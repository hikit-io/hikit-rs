...
pub struct CreateProjectRoleParams {
    pub create_update_role_request_bean: crate::models::CreateUpdateRoleRequestBean
}
...
pub struct GetProjectRoleParams {
    ...
    pub exclude_inactive_users: Option<bool>
}
...
pub async fn create_project_role(configuration: &configuration::Configuration, params: CreateProjectRoleParams) -> Result<crate::models::ProjectRole, Error<CreateProjectRoleError>> {
...
pub async fn delete_project_role(configuration: &configuration::Configuration, params: DeleteProjectRoleParams) -> Result<(), Error<DeleteProjectRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn fully_update_project_role(configuration: &configuration::Configuration, params: FullyUpdateProjectRoleParams) -> Result<crate::models::ProjectRole, Error<FullyUpdateProjectRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_role(configuration: &configuration::Configuration, params: GetProjectRoleParams) -> Result<crate::models::ProjectRole, Error<GetProjectRoleError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let project_id_or_key = params.project_id_or_key;
    let id = params.id;
    let exclude_inactive_users = params.exclude_inactive_users;
...
pub async fn get_project_role_by_id(configuration: &configuration::Configuration, params: GetProjectRoleByIdParams) -> Result<crate::models::ProjectRole, Error<GetProjectRoleByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_role_details(configuration: &configuration::Configuration, params: GetProjectRoleDetailsParams) -> Result<Vec<crate::models::ProjectRoleDetails>, Error<GetProjectRoleDetailsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_roles(configuration: &configuration::Configuration, params: GetProjectRolesParams) -> Result<::std::collections::HashMap<String, String>, Error<GetProjectRolesError>> {
    let local_var_configuration = configuration;
...
pub async fn partial_update_project_role(configuration: &configuration::Configuration, params: PartialUpdateProjectRoleParams) -> Result<crate::models::ProjectRole, Error<PartialUpdateProjectRoleError>> {
    let local_var_configuration = configuration;
