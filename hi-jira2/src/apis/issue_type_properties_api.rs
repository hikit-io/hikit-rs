...
pub async fn delete_issue_type_property(configuration: &configuration::Configuration, params: DeleteIssueTypePropertyParams) -> Result<(), Error<DeleteIssueTypePropertyError>> {
...
pub async fn get_issue_type_property(configuration: &configuration::Configuration, params: GetIssueTypePropertyParams) -> Result<crate::models::EntityProperty, Error<GetIssueTypePropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_type_property_keys(configuration: &configuration::Configuration, params: GetIssueTypePropertyKeysParams) -> Result<crate::models::PropertyKeys, Error<GetIssueTypePropertyKeysError>> {
    let local_var_configuration = configuration;
...
pub async fn set_issue_type_property(configuration: &configuration::Configuration, params: SetIssueTypePropertyParams) -> Result<serde_json::Value, Error<SetIssueTypePropertyError>> {
    let local_var_configuration = configuration;
