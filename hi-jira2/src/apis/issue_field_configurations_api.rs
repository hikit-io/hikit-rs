...
pub struct AssignFieldConfigurationSchemeToProjectParams {
    pub field_configuration_scheme_project_association:
        crate::models::FieldConfigurationSchemeProjectAssociation,
}

/// struct for passing parameters to the method [`create_field_configuration`]
#[derive(Clone, Debug, Default)]
pub struct CreateFieldConfigurationParams {
    pub field_configuration_details: crate::models::FieldConfigurationDetails,
}

/// struct for passing parameters to the method [`create_field_configuration_scheme`]
#[derive(Clone, Debug, Default)]
pub struct CreateFieldConfigurationSchemeParams {
    /// The details of the field configuration scheme.
    pub update_field_configuration_scheme_details:
        crate::models::UpdateFieldConfigurationSchemeDetails,
}
...
/// struct for passing parameters to the method [`delete_field_configuration_scheme`]
#[derive(Clone, Debug, Default)]
pub struct DeleteFieldConfigurationSchemeParams {
...
/// struct for passing parameters to the method [`remove_issue_types_from_global_field_configuration_scheme`]
#[derive(Clone, Debug, Default)]
pub struct RemoveIssueTypesFromGlobalFieldConfigurationSchemeParams {
    /// The ID of the field configuration scheme.
    pub id: i64,
    /// The issue type IDs to remove.
    pub issue_type_ids_to_remove: crate::models::IssueTypeIdsToRemove,
}

/// struct for passing parameters to the method [`set_field_configuration_scheme_mapping`]
#[derive(Clone, Debug, Default)]
pub struct SetFieldConfigurationSchemeMappingParams {
    /// The ID of the field configuration scheme.
    pub id: i64,
    pub associate_field_configurations_with_issue_types_request:
        crate::models::AssociateFieldConfigurationsWithIssueTypesRequest,
}

/// struct for passing parameters to the method [`update_field_configuration`]
#[derive(Clone, Debug, Default)]
pub struct UpdateFieldConfigurationParams {
    /// The ID of the field configuration.
    pub id: i64,
    pub field_configuration_details: crate::models::FieldConfigurationDetails,
}

/// struct for passing parameters to the method [`update_field_configuration_items`]
#[derive(Clone, Debug, Default)]
pub struct UpdateFieldConfigurationItemsParams {
    /// The ID of the field configuration.
    pub id: i64,
    pub field_configuration_items_details: crate::models::FieldConfigurationItemsDetails,
}
...
pub async fn create_field_configuration(
    configuration: &configuration::Configuration,
    params: CreateFieldConfigurationParams,
) -> Result<crate::models::FieldConfiguration, Error<CreateFieldConfigurationError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let field_configuration_details = params.field_configuration_details;
...
pub async fn create_field_configuration_scheme(
    configuration: &configuration::Configuration,
    params: CreateFieldConfigurationSchemeParams,
) -> Result<crate::models::FieldConfigurationScheme, Error<CreateFieldConfigurationSchemeError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let update_field_configuration_scheme_details =
        params.update_field_configuration_scheme_details;
...
pub async fn delete_field_configuration(
    configuration: &configuration::Configuration,
    params: DeleteFieldConfigurationParams,
...
pub async fn delete_field_configuration_scheme(
    configuration: &configuration::Configuration,
    params: DeleteFieldConfigurationSchemeParams,
...
pub async fn remove_issue_types_from_global_field_configuration_scheme(
    configuration: &configuration::Configuration,
    params: RemoveIssueTypesFromGlobalFieldConfigurationSchemeParams,
) -> Result<serde_json::Value, Error<RemoveIssueTypesFromGlobalFieldConfigurationSchemeError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let id = params.id;
    let issue_type_ids_to_remove = params.issue_type_ids_to_remove;
...
pub async fn set_field_configuration_scheme_mapping(
    configuration: &configuration::Configuration,
    params: SetFieldConfigurationSchemeMappingParams,
) -> Result<serde_json::Value, Error<SetFieldConfigurationSchemeMappingError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let id = params.id;
    let associate_field_configurations_with_issue_types_request =
        params.associate_field_configurations_with_issue_types_request;
...
pub async fn update_field_configuration(
    configuration: &configuration::Configuration,
    params: UpdateFieldConfigurationParams,
...
pub async fn update_field_configuration_items(
    configuration: &configuration::Configuration,
    params: UpdateFieldConfigurationItemsParams,
) -> Result<serde_json::Value, Error<UpdateFieldConfigurationItemsError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let id = params.id;
    let field_configuration_items_details = params.field_configuration_items_details;
...
pub async fn update_field_configuration_scheme(
    configuration: &configuration::Configuration,
    params: UpdateFieldConfigurationSchemeParams,
