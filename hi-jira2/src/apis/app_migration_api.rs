...
pub async fn app_issue_field_value_update_resource_update_issue_fields_put(
    configuration: &configuration::Configuration,
    params: AppIssueFieldValueUpdateResourceUpdateIssueFieldsPutParams,
) -> Result<serde_json::Value, Error<AppIssueFieldValueUpdateResourceUpdateIssueFieldsPutError>> {
    ...
    local_var_req_builder =
        local_var_req_builder.header("Atlassian-Account-Id", atlassian_account_id.to_string());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AppIssueFieldValueUpdateResourceUpdateIssueFieldsPutError> =
...
pub async fn migration_resource_update_entity_properties_value_put(
    configuration: &configuration::Configuration,
    params: MigrationResourceUpdateEntityPropertiesValuePutParams,
) -> Result<(), Error<MigrationResourceUpdateEntityPropertiesValuePutError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationResourceUpdateEntityPropertiesValuePutError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migration_resource_workflow_rule_search_post(
    configuration: &configuration::Configuration,
    params: MigrationResourceWorkflowRuleSearchPostParams,
) -> Result<
    crate::models::WorkflowRulesSearchDetails,
    Error<MigrationResourceWorkflowRuleSearchPostError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationResourceWorkflowRuleSearchPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
