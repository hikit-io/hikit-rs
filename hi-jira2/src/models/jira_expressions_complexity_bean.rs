...
impl JiraExpressionsComplexityBean {
    pub fn new(
        steps: Option<crate::models::JiraExpressionsComplexityValueBean>,
        expensive_operations: Option<crate::models::JiraExpressionsComplexityValueBean>,
        beans: Option<crate::models::JiraExpressionsComplexityValueBean>,
        primitive_values: Option<crate::models::JiraExpressionsComplexityValueBean>,
