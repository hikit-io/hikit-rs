...
impl Form {
        ...
        T: Into<Cow<'static, str>>,
    {
        ...
        boundary
            .chain(header)
            .chain(part.value.into_stream().map_err(|e| Error("".to_string())))
...
impl Part {
    ...
    pub fn mime_str(self, mime: &str) -> crate::Result<Part> {
        Ok(self.mime(mime.parse().map_err(|e| crate::Error("e".to_string()))?))
    }
